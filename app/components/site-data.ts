...
export const sports = [
  ...
  { slug: "futsal", name: "Futsal", description: "Fast, possession-led analysis with compact-team structures, substitutions and rapid video review.", highlights: ["Futsal-specific team structure", "Fast live event coding", "Player and substitution context", "Rapid coach review"] },
  { slug: "rugby-union", name: "Rugby Union", description: "Phase-based analysis, scoring, player status and review workflows designed around rugby union.", highlights: ["Union-specific scoring and match context", "Phase and event coding", "Player status and substitutions", "Coach-ready clip delivery"] },
  { slug: "rugby-league", name: "Rugby League", description: "Set-based match analysis, scoring, player status and video review tailored to rugby league.", highlights: ["League-specific scoring context", "Set and event review", "Player status and substitutions", "Fast delivery to coaches"] },
  { slug: "american-football", name: "American Football", description: "Down, distance, possession and play-based analysis for American football coaching and performance workflows.", highlights: ["Down-and-distance context", "Play and possession coding", "Player-linked review", "Coach and unit clip delivery"] },
  ...
  { slug: "handball", name: "Handball", description: "Fast-possession analysis, player context, scoring events and video review for handball teams.", highlights: ["Possession and scoring context", "Player and lineup review", "Fast live coding", "Coach-ready clips"] },
