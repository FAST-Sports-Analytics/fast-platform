...
from app.api.routes import admin_releases, admin_summary, auth, customer_downloads, diagnostics, licences, organisation_management, subscriptions, updates, users, live_dashboards, access_programmes
...
app.include_router(access_programmes.router, prefix="/api/v1")
